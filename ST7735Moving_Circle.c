...
int main(void){
  ...
  ST7735_InitR(INITR_REDTAB);
	...
	ST7735_DrawChar(35+10,132,'0',ST7735_RED,ST7735_YELLOW, 1);
	ST7735_DrawChar(50+10,132,'0',ST7735_RED,ST7735_YELLOW, 1);
  ...
  while(1){
		...
		ST7735_DrawLine(x1, y1, x2, y2,ST7735_RED );
		SysTick_Wait10ms(4);
